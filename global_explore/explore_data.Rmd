...
To explore the OHI Global data for Philippines, focusing on where data are estimated (gapfilled) instead of available in global data sets for Philippines.

----

## Gapfilling in Philippines
